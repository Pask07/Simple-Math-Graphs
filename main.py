...
def parabola(a,b,c):
    ...
    if delta > 0:
        ...
        plt.text(0 , 0 , "Nessuna intersezione con l'asse x.", fontsize = 10 , ha = 'left')
...
def circonferenza(xc,yc,r):
    ...
    #calcola il coseno  e il seno di ogni angolo theta che verranno moltiplicati per il raggio
...
def ellisse(a,b):
    ...
    #calcola il coseno e il seno per ogni angolo theta e viene moltiplicato per i due parametri dell'equazione dell'ellisse
...
def main():
    ...
    #menu dove l'utente inserisce l'input del luogo geometrico che vuole graficare e successivamente inserisce i parametri
    #necessari alle procedure
    while True:
